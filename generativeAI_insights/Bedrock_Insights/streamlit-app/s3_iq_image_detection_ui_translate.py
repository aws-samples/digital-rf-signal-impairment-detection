                    ...
                    if st.button("Load Selected Image"):
                        ...
                        if agent_id:
                            ...
                            try:
                                ...
                                input_text = f"Analyze image from bucket: {bucket_name}, file: {selected_file}"
                                if language_code != 'en':
                                    input_text += f". Translate the response to {language_code}."
...
if __name__ == '__main__':
    ...
    interpret_IQ_image("vebem-satcom-iq-constellation-demo", "iq-constellation-plots-8psk/")